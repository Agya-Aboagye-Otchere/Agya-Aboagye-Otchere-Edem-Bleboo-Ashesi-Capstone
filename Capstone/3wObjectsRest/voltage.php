...
switch ($method) {
    ...
    case 'POST':
        ...
        $stmt = $con->prepare('INSERT INTO voltage (reading_time, esp_ID, V) VALUES (CURRENT_TIMESTAMP, ?, ?)');
        
        // Bind parameters to the prepared statement
        // Assuming $esp_ID is the value of esp_ID corresponding to the device
        $stmt->bind_param("id", $esp_ID, $V); // Use "d" for double type and "i" for integer type
